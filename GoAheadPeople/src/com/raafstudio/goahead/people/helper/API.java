			...
			try {
				...
				case so.modul_notification:
					...
					for (int i = 0; i < jar.length(); i++) {
						...
						notif.setUser_action_id(jo.getInt("user_action_id"));
						...
						notif.getUser_profile().setBio(jo1.getString("bio"));
						...
						for (int j = 0; j < jar1.length(); j++) {
							...
							art.setJob_location(jo1.getString("job_location"));
							art.setBio(jo1.getString("bio"));
							art.setUser_id(jo1.getInt("user_id"));
							art.setLink(jo1.getString("link"));
							art.setEncrypted_id(jo1.getString("encrypted_id"));

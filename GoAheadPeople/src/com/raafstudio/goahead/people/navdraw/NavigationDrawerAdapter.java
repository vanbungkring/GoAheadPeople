...
public class NavigationDrawerAdapter extends
	...
	public void onBindViewHolder(NavigationDrawerAdapter.ViewHolder viewHolder,
		...
		viewHolder.textViewInfo.setText(mData.get(i).getInfo());
		...
		if (mSelectedPosition == i || mTouchedPosition == i) {
			viewHolder.itemView.setBackgroundColor(viewHolder.itemView
					...
					.getColor(R.color.transparent_white_percent_20));
		} else {
	...
	public static class ViewHolder extends RecyclerView.ViewHolder {
		...
		public ViewHolder(View itemView) {
			...
			textViewInfo = (TextView) itemView.findViewById(R.id.item_info);
			vSpace = (View) itemView.findViewById(R.id.NavdrawSpace);
		}
	}
}
